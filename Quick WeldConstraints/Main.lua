...
local function Main()
	...
	warn("Parts successfully welded to "..parts[1].Name.."!")
end

-- Bind to button
local openPlugin = plugin:CreateToolbar("Quick WeldConstraints"):CreateButton("Quick Weld","Select a group or several parts to weld to the first selected part!","rbxassetid://5899414710")
