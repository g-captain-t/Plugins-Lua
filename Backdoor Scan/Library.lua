...
-- Divided into classes in case I add a UI
-- 

local Library = {}

 Library.yellowFlags = {	
	"require","TeleportService","PromptPurchase" 
}
 Library.orangeFlags = {
	"loadstring","string.byte",":Run()", "serverscriptservice", "script.Parent=game.ServerScriptService"
}
 Library.redFlags = { 
	"synapse", "getfenv","setfenv", "getsenv", "luraph", "Instance.new('Script", 'Instance.new("Script', "\239\191\188"
}
...
local function Library.matchString(source, Flag)
